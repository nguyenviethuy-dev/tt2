  ...
  if (state.items.length === 0) {
    return (
      <SafeAreaView className="flex-1 justify-center items-center p-5 bg-white">
        ...
        />
        <Text className="text-lg text-center mb-5">Your cart is ready for you to begin filling it with gifts :)</Text>
  ...
  return (
    <SafeAreaView className="flex-1 bg-white">
      ...
      <View className="p-4 border-t border-gray-200">
        ...
        <Button onPress={() => router.push("/checkout")} className="w-full mb-2 h-16 justify-center items-center">
        <Text className="text-red-600 text-lg">Checkout now</Text>
        </Button>
        <Button variant="outline" onPress={() => router.push("/")} className="w-full mb-2 h-16 justify-center items-center">
