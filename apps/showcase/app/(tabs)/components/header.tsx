...
// //                   />
// //                 ) : (
// //                   <Text style={{ fontSize: 20, fontWeight: "bold" }} className="dark:text-white">FamVibe</Text>
// //                 )}
// //               </TouchableOpacity>
...
// //                             <Text className={`${textColor}`}>Settings</Text>
// //                           </View>
// //                         </TouchableOpacity>
// //                         <TouchableOpacity
// //                           className={`block px-4 py-2 text-sm ${isDarkColorScheme ? "text-gray-300 hover:bg-gray-700" : "text-gray-700 hover:bg-gray-100"}`}
...
// //                             <Text className={`${textColor}`}>Logout</Text>
// //                           </View>
// //                         </TouchableOpacity>
// //                       </View>
// //                     )}
