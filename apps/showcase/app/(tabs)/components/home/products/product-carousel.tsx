...
//       handleNext()
//     }, 10000) // đổi sản phẩm sau 20 seconds
...
//             className={`w-[280px] rounded-2xl shadow-lg p-4 ${isDarkColorScheme ? "bg-gray-800" : "bg-white"}`}
//             style={{
...
//                   />
//                 ))}
//                 <Text className="ml-2 text-sm text-gray-600">({products[currentIndex].reviews})</Text>
//               </View>
...
//               <TouchableOpacity className="mt-2 bg-black py-3 rounded-xl" activeOpacity={0.8}>
